        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="<?php echo e(route('recurring-transactions.store')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <select name="type" id="type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <option value="income"><?php echo e(__('Revenu')); ?></option>
                                <option value="expense"><?php echo e(__('Dépense')); ?></option>
                                <option value="transfer"><?php echo e(__('Virement')); ?></option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="description" id="description" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <input type="number" name="amount" id="amount" step="0.01" min="0" class="block w-full rounded-md border-gray-300 pl-7 pr-12 focus:border-indigo-500 focus:ring-indigo-500" required>
                            </div>
                        ...
                        <div>
                            ...
                            <select name="account_id" id="account_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($account->id); ?>"><?php echo e($account->name); ?> (<?php echo e($account->currency->code); ?>)</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="frequency" id="frequency" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                <option value="daily"><?php echo e(__('Quotidienne')); ?></option>
                                <option value="weekly"><?php echo e(__('Hebdomadaire')); ?></option>
                                <option value="monthly"><?php echo e(__('Mensuelle')); ?></option>
                                <option value="yearly"><?php echo e(__('Annuelle')); ?></option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="interval" id="interval" min="1" value="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="times_to_run" id="times_to_run" min="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="<?php echo e(route('recurring-transactions.index')); ?>" class="inline-flex justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
...
<?php endif; ?> <?php /**PATH C:\laragon\www\HomeFinanceManager-new\resources\views/recurring-transactions/create.blade.php ENDPATH**/ ?>