        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('currencies.update', $currency) }}" class="space-y-6">
                        @csrf
                        @method('PUT')

                        <div>
                            <x-input-label for="code" :value="__('Code (ISO)')" />
                            <x-text-input id="code" name="code" type="text" class="mt-1 block w-full" :value="old('code', $currency->code)" required maxlength="3" />
                        ...
                        <div>
                            ...
                            <x-text-input id="symbol" name="symbol" type="text" class="mt-1 block w-full" :value="old('symbol', $currency->symbol)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="exchange_rate" name="exchange_rate" type="number" step="0.000001" class="mt-1 block w-full" :value="old('exchange_rate', $currency->exchange_rate)" required />
