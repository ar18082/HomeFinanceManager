        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('savings-goals.store') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <x-text-input id="target_amount" name="target_amount" type="number" class="block w-full pl-7" step="0.01" min="0" :value="old('target_amount')" required />
                            </div>
                        ...
                        <!-- Montant initial -->
                        <div>
                            <x-input-label for="current_amount" :value="__('Montant initial (optionnel)')" />
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <span class="text-gray-500 sm:text-sm">€</span>
                                </div>
                                <x-text-input id="current_amount" name="current_amount" type="number" class="block w-full pl-7" step="0.01" min="0" :value="old('current_amount')" />
                            </div>
                        ...
                        <div>
                            ...
                            <x-text-input id="color" name="color" type="color" class="mt-1 block w-20" :value="old('color', '#3B82F6')" />
