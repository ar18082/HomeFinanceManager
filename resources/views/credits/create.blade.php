        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('credits.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="interest_rate" name="interest_rate" type="number" step="0.01" class="mt-1 block w-full" :value="old('interest_rate')" required />
                                    <x-input-error :messages="$errors->get('interest_rate')" class="mt-2" />
                                </div>

                                <div>
                                    <x-input-label for="duration_months" :value="__('Durée (mois)')" />
                                    <x-text-input id="duration_months" name="duration_months" type="number" class="mt-1 block w-full" :value="old('duration_months')" required />
