                    ...
                    <form action="{{ route('recurring-transactions.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="frequency" id="frequency" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                <option value="daily">{{ __('Quotidienne') }}</option>
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="{{ route('recurring-transactions.index') }}" class="inline-flex justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                {{ __('Annuler') }}
                            </a>
